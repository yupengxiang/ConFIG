...
Examples:
    python3 tools/Report/run_burgers_experiments.py --epochs 1000 --methods standard pcgrad config
    python3 tools/Report/run_burgers_experiments.py --epochs 30000 --num-run 3 --methods standard pcgrad config mconfig
    python3 tools/Report/run_burgers_experiments.py --epochs 30000 --num-run 3 --methods standard pcgrad config mconfig --parallel-methods 4
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--save-path",
        default="./PINN_trained/Burgers/Report/",
